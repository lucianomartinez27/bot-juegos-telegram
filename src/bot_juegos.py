...
class BotDeJuegosTelegram(BotTelegram):
    def __init__(self, nombre, token):
        ...
        self.diccionario_de_juegos = {"ahorcado": BotTelegramAhorcado(), "mastermind": BotMastermind()}
        try:
    ...
    def juegos(self, update, context):
        ...
        opciones = [[InlineKeyboardButton(juego.capitalize(), callback_data=juego)]\
                    for juego in self.diccionario_de_juegos.keys()]
